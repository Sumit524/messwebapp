...
// import './Common.css'
import Admin_Profile from "../../imgs/Admin_Profile.avif"
function MainDash() {
      ...
      <div className="MainDash1234" style={{height:"90vh"}}>
        {userData ? (
           <div  className="Student_img" style={{display:"flex",flexDirection:"column"}}>
            ...
            {/* <img src="https://img.freepik.com/premium-photo/profile-icon-white-background_941097-161524.jpg" alt=""  style={{marginBottom:"1.5rem"}}/> */}
            <img src={Admin_Profile} alt=""  style={{marginBottom:"1.5rem"}}/>
          ...
          <h1 className="DashboardText127 text-center" style={{ color: 'black', fontSize: '32px', marginBottom: '20px',backgroundColor:"transparent" }}>Admin Details</h1>
