  ...
  return (
    <>
      ...
      <body style={styles.bodyNotice}>
        <h1 style={{fontSize:"1.7rem",backgroundColor:"transparent",textShadow: "2px 1px 2px rgb(206, 21, 107)",text:"black"}}> <span style={{backgroundColor:"white",borderRadius:"10px",color:"black"}}>Notice Board</span></h1>
